  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-6">
      <div className="container max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6 md:p-10">
        <h2 className="text-3xl font-bold text-center text-gray-800 mb-6 mt-10">Contact Me</h2>
    ...
    <p className="text-gray-700">Karachi, Pakistan</p>
        ...
        <div className="mt-8 text-center">
          ...
          <div className="flex justify-center gap-6 mt-3">
            ...
            <Link href="https://github.com/tayyab2468" target="_blank" className="text-black hover:text-blue-600 text-2xl">
              <GitHubIcon />
            </Link>
            <Link href="https://www.linkedin.com/in/tayyab-basharat-8a896a273/" target="_blank" className="text-blue-700 hover:text-blue-900 text-2xl">
              <LinkedInIcon />
            </Link>
          </div>
        </div>
